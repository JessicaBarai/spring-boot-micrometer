...
public class SpringbootBackendApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		System.out.println(this.userRepository.save(new User("Jessica", "Andersson", "jessicaAndersson@hotmail.com")));
		System.out.println(this.userRepository.save(new User("Carl", "Svensson", "carlSvensson@gmail.com")));
